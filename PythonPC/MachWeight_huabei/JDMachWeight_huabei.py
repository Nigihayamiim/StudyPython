...
if __name__ == '__main__':
    ...
    sql_updatechaozhong = 'update OrderWeight_huabei set ischeck = "超重" where tknum = %s'
    sql_shaozhong = 'update OrderWeight_huabei set ischeck = "少重" where tknum = %s'
    sql_zhengchang = 'update OrderWeight_huabei set ischeck = "正常" where tknum = %s'
    sql_zhongzholanshou = 'update OrderWeight_huabei set ischeck = "终止揽收" where tknum = %s'
    sql_kehuquxiao = 'update OrderWeight_huabei set ischeck = "客户取消" where tknum = %s'
    sql_wudanhao = 'update OrderWeight_huabei set ischeck = "无单号" where tknum = %s'
